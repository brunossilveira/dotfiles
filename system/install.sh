...
echo "Increases the time the menu bar shows when mouse is at the top of the screen"
defaults write com.citrix.receiver.nomas MenuBarAutoShowDelayEnabled -bool YES
defaults write com.citrix.receiver.nomas MenuBarAutoShowDelay -float 3.0
