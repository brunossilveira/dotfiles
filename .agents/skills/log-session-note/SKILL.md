---
name: log-session-note
description: Create a standalone note for this coding session
...
Then run this command to create the standalone note in your Obsidian vault:
